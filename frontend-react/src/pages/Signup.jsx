...
export default function Signup() {
  const { signup, error, backendEnabled } = useAuthContext();
    ...
    <div className="min-h-screen bg-graphite text-paper grid-texture">
      ...
      <main className="max-w-md mx-auto px-6 pt-16">
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <div className="channel-tag text-amber mb-3">Create account</div>
          <h1 className="font-display italic text-4xl mb-8">Start reading signal.</h1>
